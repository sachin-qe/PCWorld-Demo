...
describe "Verify Contact Us link on Homepage" ,:selenium => true,:retry => 3  do
  before(:all) do
  ...
  it "Verify Goes to the About page" do
    ...
    @Template.clickandwait(@selenium.find_element(:css,"#menu-item-1550231 a"))
  ...
  it "Verify Page is populated with page content" do
