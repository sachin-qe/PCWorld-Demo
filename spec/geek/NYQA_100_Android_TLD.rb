...
describe "Verify Android TLD link on Homepage" ,:selenium => true,:retry => 3 do
  before(:all) do
  ...
  it "Verify Goes to the correct page" do
    @Template.clickandwait(@selenium.find_element(:css,"#menu-item-1550220>a"))
    @selenium.current_url.should == "#{@Template.get_Base_URL}/category/android/"
  end
  ...
  it"Verify Page Title is correct"do
    @Template.verifyText("css","title","Android News & Rumors | Tag Page | Geek.com") 
  end
