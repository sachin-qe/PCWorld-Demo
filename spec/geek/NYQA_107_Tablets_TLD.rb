...
describe "Verify Tablets TLD link on Homepage" ,:selenium => true,:retry => 3 do
  before(:all) do
  ...
  it "Verify Goes to the correct page" do
    @Template.clickandwait(@selenium.find_element(:link_text,"Tablets"))
    @selenium.current_url.should == "#{@Template.get_Base_URL}/category/tablets/"
  end
  ...
  it"Verify Page Title is correct"do
    @Template.verifyText("css","title","Tablets News & Rumors | Tag Page | Geek.com") 
  end
