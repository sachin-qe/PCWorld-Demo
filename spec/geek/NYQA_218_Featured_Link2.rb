...
describe "Verify Featured_Link2" ,:selenium => true,:retry => 3  do
  before(:all) do
    @selenium = RSpec.configuration.selenium
    @Template = TemplatePage.new(@selenium)   
    @wait = @Template.set_timeout(30)
    @selenium.get("#{@Template.get_Base_URL}/featured/fast-books-cheap-books-561470/")
  end
  ...
  it"Verify it goes to correct URL" do
    @selenium.current_url.should == "#{@Template.get_Base_URL}/featured/fast-books-cheap-books-561470/"
  end

  it"Verify Page Title is correct"do
    @Template.verifyText("css","title","Fast Books, Cheap Books | Featured | Geek.com") 
  end
