...
describe "Verify Deals_2_Link2" ,:selenium => true,:retry => 3  do
  before(:all) do
    @selenium = RSpec.configuration.selenium
    @Template = TemplatePage.new(@selenium)   
    @wait = @Template.set_timeout(30)
    @selenium.get("#{@Template.get_Base_URL}/deals-2/geek-deals-lenovo-ideapad-y410p-haswell-laptop-nexus-4-more-1559351/")
  end 
  ...
  it"Verify it goes to correct URL" do
    @selenium.current_url.should == "#{@Template.get_Base_URL}/deals-2/geek-deals-lenovo-ideapad-y410p-haswell-laptop-nexus-4-more-1559351/"
  end

  it"Verify Page Title is correct"do
    @Template.verifyText("css","title","Geek deals: Lenovo IdeaPad Y410p Haswell laptop, Nexus 4, more | Deals | Geek.com") 
  end
