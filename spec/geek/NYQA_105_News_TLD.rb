...
describe "Verify News TLD link on Homepage" ,:selenium => true,:retry => 3 do
  before(:all) do
  ...
  it "Verify Goes to the correct page" do
    @Template.clickandwait(@selenium.find_element(:link_text,"News"))
    @selenium.current_url.should be == "#{@Template.get_Base_URL}/category/news/"
  end
  ...
  it"Verify Page Title is correct"do
    @Template.verifyText("css","title","News News & Rumors | Tag Page | Geek.com") 
  end
