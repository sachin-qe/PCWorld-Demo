...
describe "Verify Ads tags on Review article page" ,:selenium => true,:retry => 3 do
  before(:all) do
    @selenium = RSpec.configuration.selenium
    @lib_obj = Function_Library.new
    @lib_obj.set_driver(@selenium)
    @wait = @lib_obj.set_timeout(30)
    @selenium.get("#{@lib_obj.get_Base_URL}/article2/0,2817,2424510,00.asp")
  end  
  ...
  describe "Verify adheader 405- 1x2 - Displayed" ,:selenium => true do
    it"Verify adheader ad405 - 1x2 " do
