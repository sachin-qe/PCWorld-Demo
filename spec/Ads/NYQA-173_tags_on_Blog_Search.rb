...
describe "Verify Ads tags on Blog Search page" ,:selenium => true,:retry => 3 do
  before(:all) do
    ...
    @selenium.get("http://#{@config['baseurl3']}/search?qry=malware&x=0&y=0")
  end
  ...
  describe "Verify adheader 415- 300x250 - Displayed" ,:selenium => true do
    it"Verify adModule ad415 - 300x250" do
      @lib_obj.check_ads_display("ad300x250securitywatchdoor_BTF", 300, 250)
    end 
  end

  describe "Verify adheader 415- 300x250 - tags" ,:selenium => true do
    include_examples "Check Tags","ad300x250securitywatchdoor_BTF","Verify adheader 415- 300x250"
  end
